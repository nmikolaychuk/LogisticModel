...
// LogisticModel.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLogisticModelApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CLogisticModelApp

CLogisticModelApp::CLogisticModelApp()
{
...
// Единственный объект CLogisticModelApp

CLogisticModelApp theApp;


// Инициализация CLogisticModelApp

BOOL CLogisticModelApp::InitInstance()
{
